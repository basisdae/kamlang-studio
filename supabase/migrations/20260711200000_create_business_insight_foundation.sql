...
--   20260711210000_create_business_insight_foundation_fixed.sql
-- This draft had an invalid seed UUID: …cccccccc00pos
-- =============================================================================
-- Business Insight Foundation Migration (BROKEN SEED UUID — do not use)
...
(
  'cccccccc-cccc-cccc-cccc-cccccccc00pos',
  '11111111-1111-1111-1111-111111111111',
  null,
  '22222222-2222-2222-2222-222222222201',
...
insert into public.bi_activity_logs (
  workspace_id, entity_type, entity_id, action, actor_name, summary, metadata
) values (
  '11111111-1111-1111-1111-111111111111',
  'workspace',
  '11111111-1111-1111-1111-111111111111',
